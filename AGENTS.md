...
- [.Codex/docs/architectural_patterns.md](.Codex/docs/architectural_patterns.md) — design patterns, state model, rendering approach, conventions used throughout the codebase
